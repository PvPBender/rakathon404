...
class M_1_2:  # Zdravotní pojištění
    ...
    M_1_2_3: List[str] = field(default_factory=list) # Číslo zdravotního pojištění – Podmíněně povinné, 1..1 (0..1 dětská MDS)
...
#     M_1: Optional['M_1'] = None
#     M_A: Optional['MA'] = None
#     M_B1: Optional['MB1'] = None
